    ...
    <div>
      ...
      <div className="flex justify-center gap-4 mt-8">
        <button
          ...
          className="flex items-center justify-center size-11 rounded-full border border-white/15 text-neutral-300 transition-all duration-200 hover:border-emerald-400/50 hover:text-emerald-400 hover:scale-105 active:scale-95"
        >
          ←
        </button>
        <button
